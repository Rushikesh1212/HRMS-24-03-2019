...
import { ProjectSettings } from '/imports/s3Config/api/ProjectSettings.js';
...
if(s3Data){
    ...
    if (process.env.S3) {
        ...
        if (s3Conf && s3Conf.key && s3Conf.secret && s3Conf.bucket && s3Conf.region) {
            ...
            export const UploadImg = new FilesCollection({
                ...
                onAfterUpload(fileRef) {
                    ...
                    _.each(fileRef.versions, (vRef, version) => {
                        ...
                        const filePath = 'UploadImg/' + fileRef._id +'.' + fileRef.extension;
                        s3.putObject({
            ...
            const _origRemove = UploadImg.remove;
            UploadImg.remove = function(search) {
