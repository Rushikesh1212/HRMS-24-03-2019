...
class RoleDesignation extends Component{
	constructor(props){
		...
		var formValues = {
			...
			selectedEmploymentCategory 	: this.state.selectedEmploymentCategory,
			selectedEmploymentType		: this.state.selectedEmploymentType,
			status						: "Allocate",
	...
	handleEmploymentChange=changeEvent=>{
		this.setState({
			"selectedEmploymentCategory" : changeEvent.target.value,
		});
	}

	handleEmploymentType=changeEvent=>{
		this.setState({
			"selectedEmploymentType"	: changeEvent.target.value,
		});
	}
									...
									<div className="form-group">
								    	<label >Allocate Department</label>
										  <select className="custom-select form-control" id="inputGroupSelect01" ref="allocateDepartment" onChange={this.handleChange.bind(this)}>
										    <option  value={this.state.allocateDepartment}>Choose...</option>
									...
									<div className="form-group">
									    <label >Designation</label>
									     <select className="custom-select form-control" id="inputGroupSelect01"  ref="designation" onChange={this.handleChange.bind(this)}>
										    <option  value={this.state.designation}>Choose...</option>
									...
									<div className="form-group">
									    <label >Reporting Location</label>
									     <select className="custom-select form-control" id="inputGroupSelect01"  ref="reportingLocation" onChange={this.handleChange.bind(this)}>
										    <option  value={this.state.reportingLocation}>Choose...</option>
									   ...
									   <div className="form-group">
									    <label >Sub-Department</label>
									     <select className="custom-select form-control" id="inputGroupSelect01"  ref="subDepartment" onChange={this.handleChange.bind(this)}>
										    <option  value={this.state.subDepartment}>Choose...</option>
										    <option value="1">One</option>
										    <option value="2">Two</option>
										    <option value="3">Three</option>
										  </select>
									   ...
									   <div className="form-group">
									    <label >Grade / Band</label>
									     <select className="custom-select form-control" id="inputGroupSelect01"  ref="gradeBand" onChange={this.handleChange.bind(this)}>
										    <option  value={this.state.gradeBand}>Choose...</option>
										    <option value="1">One</option>
										    <option value="2">Two</option>
										    <option value="3">Three</option>
										  </select>
									   ...
									   <div className="form-group">
									    <label >Reporting Manager</label>
									     <select className="custom-select form-control" id="inputGroupSelect01"  ref="reportingManager" onChange={this.handleChange.bind(this)}>
										    <option  value={this.state.reportingManager}>Choose...</option>
										    <option value="1">One</option>
										    <option value="2">Two</option>
										    <option value="3">Three</option>
										  </select>
			    					...
			    					<div className="form-group">
			    						...
			    						<div>
			    							<label className="radio-inline">
				    							<input type="radio" value="regular" name="regular" checked={this.state.selectedEmploymentCategory === "regular"} name="option" ref="regular" onChange={this.handleEmploymentChange.bind(this)}/>Regular
									    	</label>
									    									   		
									    	<label className="radio-inline">
									    		<input type="radio" value="contract" name="contract" checked={this.state.selectedEmploymentCategory === "contract"} name="option" ref="contract" onChange={this.handleEmploymentChange.bind(this)}/>Contract
									    	</label>
									    </div>
									    <br/>
									     ...
									     <div>
			    							<label className="radio-inline">
									        	<input type="radio" name="fullTime" value="fullTime" ref="fullTime" checked={this.state.selectedEmploymentType === "fullTime"} onChange={this.handleEmploymentType.bind(this)}/>Full Time
									    	</label>
									   
									    	<label className="radio-inline">
									        	<input type="radio" name="partTime" value="partTime" ref="partTime" checked={this.state.selectedEmploymentType === "partTime"} onChange={this.handleEmploymentType.bind(this)}/>Part Time
									    	</label>
									    </div>
			    					</div>
			    				</div>
